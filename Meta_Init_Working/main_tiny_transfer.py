...
#    print("Loading metainit weights of tiny image new dataset for CIFAR TRAINING 3 layers")
#    checkpoint = torch.load("model_imageNet.pt")
#    model.load_state_dict(checkpoint['model_state_dict'])
    ...
    print("Updating the pretrained model")
...
#    model = list(model.model.children())[0:9]
#    model.load_state_dict(pretrained_dict)
#    model.extend([nn.Linear(4096, 10)])
#    model = nn.Sequential(*model)
#    print("Udpated New Model", model)
