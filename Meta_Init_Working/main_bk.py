...
#    print("Loading metainit weights of Tiny image net for 3 layers")
...
#    trainer_metaInit = pl.Trainer(gradient_clip_val=1.0, callbacks=[SomeCallback(model)], max_epochs=200, gpus=1)
    trainer_metaInit = pl.Trainer(gradient_clip_val=4.0,max_epochs=150, callbacks=[SomeCallback1(model),checkpoint_callback], logger=mlf_logger,gpus=1)
